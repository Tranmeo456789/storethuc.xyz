        ...
        <div class="card-body">
            <form action="{{url('admin/post/store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="title_post" id="name" autocomplete="off">
                    @error('title_post')
                ...
                <div class="form-group">
                    ...
                    <textarea name="content_post" class="form-control" id="mytextarea" cols="30" rows="5"></textarea>
                    @error('content_post')
                        <small class="text-danger">{{$message}}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="cat-post" class="form-control" id="">
                ...
                <button type="submit" name="add_post" value="Thêm mới" class="btn btn-primary">Thêm mới</button>
            </form>
        </div>
    </div>
</div>
