                                ...
                                @if ($product_cat['parent_id'] == 0)
                                    <tr class="font-weight-bolder">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('product_cat.delete',$product_cat->id)}}" class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return confirm('Bạn có chắc chắn xóa bản ghi này ?')"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @else
