        ...
        <div class="card-body">
            <form action="{{route('page.update', $page->id)}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="title_page" value="{{$page->title}}" id="title" autocomplete="off">
                    @error('title_page')
                ...
                <div class="form-group">
                    ...
                    <textarea name="content_page" id="mytextarea" class="form-control" id="content-page" cols="30" rows="5">{{$page->content}}</textarea>
                    @error('content_page')
                    <small class="text-danger">{{$message}}</small>
                @enderror
                </div>
