    ...
    @if (count($items) > 0)
        @foreach ($items as $val)
            ...
            <tr>
                ...
                <td style="width: 15%" class="text-center"><span class="badge {{$val->status_product=='con_hang'?'badge-success':'badge-danger'}} ">{{$val->status_product=='con_hang'?'Còn hàng':'Hết hàng'}}</span></td>
                <td style="width: 15%">
