...
<div id="app">
            ...
            <div id="header-wp">
                <div id="head-top" class="clearfix">
                    <div class="wp-inner">
                        ...
                        <div id="main-menu-wp" class="fl-left ml-lg-5">
    ...
    <div id="footer-wp">
        ...
        <div id="foot-bot">
            <div class="wp-inner">
                <p id="copyright"  >
                    CÔNG TY ISMART, Giấy phép kinh doanh: 0313728397, Sở kế hoạch và đầu tư thành phố Hồ Chí Minh
                </p>
            </div>
        </div>
    </div>
    ...
    $('.minus1').click(function() {
        if (Number($(this).next('.num-order').val()) >1) {
            ...
            $.ajax({
                ...
                method: "POST",
                dataType: 'json',
                data: { qty: qty, id: id, rowId: rowId, _token: _token },
                success: function(data) {
