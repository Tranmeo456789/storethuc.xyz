...
use App\Model\CatPostModel as MainModel;
use App\Http\Requests\CatPostRequest as MainRequest;
use App\Helper;
class CatPostController extends BackEndController
{
    public function __construct()
    {
        $this->controllerName     = 'catPost';
